...
(let ((normal-outer-foreground  "#303739") (normal-outer-background  "#98c379")
      ...
      (normal-center-foreground "#9399a6") (normal-center-background "#282c34")
      ...
      (insert-center-foreground "#9399a6") (insert-center-background "#282c34")
      ...
      (visual-center-foreground "#9399a6") (visual-center-background "#282c34")
